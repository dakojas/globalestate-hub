...
const AGENT_NAME = "property_description_generator";

const SUGGESTIONS = [
  "Vygeneruj popis pre Ibiza Bay Hurghada",
  "Prelož popis nehnuteľnosti do angličtiny",
  "Vylepš popis pre poslednú pridanú nehnuteľnosť",
];
      ...
      try {
        ...
        if (existing && existing.length > 0) {
          ...
          const conv = await base44.agents.createConversation({
            ...
            metadata: { name: "Generátor popisov" },
          });
          setConversation(conv);
          setMessages([]);
          unsub = base44.agents.subscribeToConversation(conv.id, (data) => {
  ...
  return (
    <div className="max-w-4xl mx-auto h-[calc(100vh-140px)] flex flex-col">
      ...
      <div className="flex items-center gap-3 mb-4 px-1">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#0a1628]">Generátor popisov</h2>
          <p className="text-xs text-gray-500">AI agent pre vytváranie a preklad popisov nehnuteľností</p>
        </div>
      </div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto space-y-4 px-1 py-4">
        {messages.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm mb-4">Napíš mi, aký popis potrebuješ vygenerovať alebo preložiť.</p>
