...
function PublicHomeInner() {
  ...
  return (
    <div data-theme={isDark ? "dark" : "light"} className="min-h-screen font-body" style={{ background: "var(--bg-page)" }}>
      ...
      <header className="sticky top-0 z-50 glass-dark border-b border-[#c5a065]/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7">
            ...
            <a href="#contact" className="text-white/60 hover:text-[#c5a065] transition-colors text-sm tracking-wide">{tr("contact")}</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[#c5a065]/15 glass-dark">
            <div className="px-4 py-4 space-y-1">
              ...
              <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="block text-white/70 hover:text-[#c5a065] py-2.5 text-sm">{tr("contact")}</a>
      ...
      {/* EYA AI Assistant */}
      <EyaChatWidget lang={lang} onOpenChange={setEyaOpen} />

      {/* Mobile WhatsApp */}
      <a href="https://wa.me/421951094706" target="_blank" rel="noopener noreferrer"
        className={`fixed right-6 z-50 flex items-center justify-center bg-[#25D366] text-white font-semibold p-3 rounded-full shadow-2xl md:px-4 md:py-3 md:gap-2 transition-all duration-300 ${eyaOpen ? "top-20 md:top-auto md:bottom-6" : "bottom-6"}`}
        title="WhatsApp">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div style={{ borderTop: "1px solid rgba(197,160,101,0.1)" }} className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to={createPageUrl("PublicBlog")} className="text-[#c5a065]/60 hover:text-[#c5a065] text-xs transition-colors">Blog</Link>
            </div>
          </div>
        </div>
      </footer>
