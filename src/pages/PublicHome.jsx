...
function PublicHomeInner() {
  ...
  return (
    <div data-theme={isDark ? "dark" : "light"} className="min-h-screen font-body" style={{ background: "var(--bg-page)" }}>
      ...
      {/* Mobile WhatsApp */}
      <a href="https://wa.me/421951094706" target="_blank" rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center bg-[#25D366] text-white font-semibold p-3 rounded-full shadow-2xl md:px-4 md:py-3 md:gap-2"
        title="WhatsApp">
